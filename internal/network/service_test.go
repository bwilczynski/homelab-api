...
func TestListDevices(t *testing.T) {
	...
	svc := NewService(map[string]UniFiBackend{"unifi": &mockUniFi{devices: devices}}, 30, slog.Default())
...
func TestListDevicesEmpty(t *testing.T) {
	svc := NewService(map[string]UniFiBackend{"unifi": &mockUniFi{devices: []adapters.UniFiDevice{}}}, 30, slog.Default())
	result, err := svc.ListDevices(context.Background())
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestGetDevice_Gateway(t *testing.T) {
	...
	svc := NewService(map[string]UniFiBackend{"unifi": &mockUniFi{devices: devices, clients: clients}}, 30, slog.Default())
...
func TestListClientsAll(t *testing.T) {
	...
	svc := NewService(map[string]UniFiBackend{"unifi": &mockUniFi{activeClients: active, offlineClients: offline}}, 30, slog.Default())
...
func TestGetClientNotFound(t *testing.T) {
	clients := testhelpers.LoadFixture[[]adapters.UniFiSta](t, "testdata/unifi-clients.json")
	svc := NewService(map[string]UniFiBackend{"unifi": &mockUniFi{clients: clients}}, 30, slog.Default())
...
func TestGetTopology_WithClients(t *testing.T) {
	...
	svc := NewService(map[string]UniFiBackend{"unifi": mock}, 30, slog.Default())
...
func TestListVLANs(t *testing.T) {
	...
	svc := NewService(map[string]UniFiBackend{"unifi": &mockUniFi{networkConf: networks}}, 30, slog.Default())
...
func TestListVLANsEmpty(t *testing.T) {
	svc := NewService(map[string]UniFiBackend{"unifi": &mockUniFi{networkConf: []adapters.UniFiNetworkConf{}}}, 30, slog.Default())
	result, err := svc.ListVLANs(context.Background())
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestListWANs(t *testing.T) {
	devices := testhelpers.LoadFixture[[]adapters.UniFiDevice](t, "testdata/unifi-devices.json")
	networks := testhelpers.LoadFixture[[]adapters.UniFiNetworkConf](t, "testdata/unifi-networkconf.json")
	svc := NewService(map[string]UniFiBackend{"unifi": &mockUniFi{devices: devices, networkConf: networks}}, 30, slog.Default())
...
func TestListSSIDs(t *testing.T) {
	wlans := testhelpers.LoadFixture[[]adapters.UniFiWlanConf](t, "testdata/unifi-wlanconf.json")
	networks := testhelpers.LoadFixture[[]adapters.UniFiNetworkConf](t, "testdata/unifi-networkconf.json")
